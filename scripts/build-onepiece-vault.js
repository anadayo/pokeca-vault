...
function build() {
  ...
  html = replaceCardMaster(html)
    ...
    .replace('<p style="margin-top:8px">姉妹サイト:', '<p style="margin-top:8px">姉妹サイト: <a href="https://anadayo.github.io/pokeca-vault/" style="color:var(--muted)">POKÉCA VAULT</a> ・ ')
    .replace(/ ・\s+<a href="onepiece-card-vault\/" style="color:var\(--muted\)">OP CARD VAULT<\/a>/, '')
    .replace('href="tsume-pokepoke/"', 'href="https://anadayo.github.io/pokeca-vault/tsume-pokepoke/"')
